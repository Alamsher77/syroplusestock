  ...
  return (
    <ScrollableContainer   style={{gap:4}}>
      ...
      <Text style={{alignSelf:'center',fontWeight:'bold',letterSpacing:1,fontSize:16,color:'#6aa',borderBottomWidth:0.2,paddingBottom:6}}>{user?.withdrawal_password ? 'Update Withdrawal  Password' : "Create New Withdrawal Password" }</Text>
       <TextInput onChangeText={user?.withdrawal_password ? setOldWithdrawalPassword : setNewWithdrawalPasswor} style={{borderBottomWidth:0.5,color:'#000',borderRadius:5,paddingHorizontal:12}} placeholderTextColor='#999' secureTextEntry placeholder={user?.withdrawal_password ? 'Enter Old withdrawal password':'Enter Create new withdrawal password'} />
       <TextInput onChangeText={user?.withdrawal_password ? setUpdateWithdrawalPassword : setReNewWithdrawalPassword} style={{borderBottomWidth:0.5,color:'#000',borderRadius:5,paddingHorizontal:12}} placeholderTextColor='#999' placeholder={user?.withdrawal_password ? 'Enter update withdrawal password':'Re Enter Create new withdrawal password'} />
