  ...
  return (
    <ScrollableContainer   style={{gap:4}}>
      ...
      <Text style={{alignSelf:'center',fontWeight:'bold',letterSpacing:1,fontSize:16,color:'#6aa',borderBottomWidth:0.2,paddingBottom:6}}>Update Login Password </Text>
       <TextInput onChangeText={setPassword} style={{borderBottomWidth:0.5,color:'#999',borderRadius:5,paddingHorizontal:12}} placeholderTextColor='#999' secureTextEntry placeholder={"Enter The Password"} />
       <TextInput onChangeText={setRePassword} style={{borderBottomWidth:0.5,color:'#999',borderRadius:5,paddingHorizontal:12}} placeholderTextColor='#999' placeholder={"Re Enter The Password"} />
